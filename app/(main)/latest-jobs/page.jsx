        ...
        <Card className="mx-auto max-w-2xl">
          <CardContent className="text-center space-y-6 py-12">
            ...
            <div className="space-y-3">
              <h3 className="text-xl font-semibold">Finding the Best Jobs for You</h3>
              <p className="text-muted-foreground">Analyzing your skills and preferences to match you with perfect opportunities</p>
            </div>
