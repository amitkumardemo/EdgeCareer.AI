...
import { PenTool, Sparkles, FileText, Send, Zap } from "lucide-react";

const quotes = [
  { text: "Your cover letter is your first handshake.", icon: PenTool, color: "text-blue-400" },
  { text: "Make every word count in your career story.", icon: Sparkles, color: "text-purple-400" },
  { text: "Tailoring is the secret to a standout application.", icon: FileText, color: "text-cyan-400" },
  { text: "Your narrative defines your professional value.", icon: Send, color: "text-indigo-400" },
  { text: "First impressions are built on great narratives.", icon: Zap, color: "text-orange-400" },
];
