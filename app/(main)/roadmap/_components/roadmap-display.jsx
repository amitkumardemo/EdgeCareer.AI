...
export default function RoadmapDisplay({ roadmap }) {
  const downloadRoadmap = () => {
    ...
    ctx.fillText('EdgeCareer.AI', 0, 0);
    ctx.restore();
    ...
    ctx.font = '16px Arial';
    ctx.textAlign = 'center';
    ctx.fillText('Generated by EdgeCareer.AI - Your Career Development Partner', 600, 1550);

    // Download
    const link = document.createElement('a');
    link.download = `EdgeCareer_Roadmap_${roadmap.title.replace(/\s+/g, '_')}.png`;
