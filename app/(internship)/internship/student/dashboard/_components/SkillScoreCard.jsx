  ...
  return (
    ...
    >
      <div className="flex items-center justify-between mb-6">
        ...
        <div className="px-3 py-1 bg-primary/10 border border-primary/20 rounded-lg text-primary text-xs font-black uppercase tracking-widest">
          LVL {level}
        </div>
      </div>
      ...
      <div className="flex items-center gap-6 mb-8">
        ...
        <div className="flex-1">
          <p className="text-sm font-bold text-slate-900 mb-1">Elite Career Readiness</p>
