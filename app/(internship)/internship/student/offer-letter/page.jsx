    ...
    <div className="space-y-6">
      ...
      <div className="bg-gradient-to-br from-primary/10 to-blue-500/5 border border-primary/20 rounded-2xl p-6 md:p-8 text-center max-w-2xl mx-auto">
        ...
        <p className="text-gray-400 text-sm mb-6">
          ...
          <strong className="text-white">TechieHelp Institute of AI</strong> for the{" "}
          <strong className="text-white">{app.batch?.program?.title}</strong> program.
        </p>
        ...
        <div className="flex flex-col gap-3 justify-center items-center mt-6">
          {pdfUrl ? (
            ...
            <button
              disabled
              className="inline-flex items-center justify-center gap-2 text-sm font-semibold px-6 py-3 bg-white/10 text-gray-500 rounded-xl cursor-not-allowed"
            >
              PDF Generating...
            </button>
          )}
