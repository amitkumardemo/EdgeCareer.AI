      ...
      <div className="container mx-auto max-w-5xl">
        ...
        >
          ...
          <p className="text-xl text-gray-600 mb-10 max-w-2xl mx-auto font-medium">
            Next Batch Starts on <span className="text-gray-900 font-bold">{formatDate()}</span>. Don't miss your chance!
          </p>
          ...
          <div className="flex items-center justify-center gap-4 md:gap-8 mb-12">
            {[
              ...
              <div key={i} className="flex flex-col items-center">
                <div className="w-20 md:w-28 h-20 md:h-28 rounded-3xl bg-white border border-slate-200 flex items-center justify-center text-4xl md:text-5xl font-black text-slate-800 shadow-md">
          ...
          <a 
            ...
            className="inline-block px-10 py-5 bg-red-600 hover:bg-red-700 text-white font-black text-lg rounded-2xl transition-all duration-300 shadow-[0_4px_15px_rgba(220,38,38,0.3)] hover:shadow-[0_6px_20px_rgba(220,38,38,0.4)] transform hover:scale-105 uppercase tracking-wider"
          >
