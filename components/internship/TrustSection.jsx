...
const TrustSection = () => {
  ...
  return (
    <section className="py-20 bg-[#F8FAFC] px-6 relative overflow-hidden">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {testimonials.map((t, i) => (
            <motion.div
              ...
              className="p-8 rounded-[2rem] bg-white border border-slate-100 hover:border-orange-500/30 transition-all duration-300 relative group shadow-sm hover:shadow-md"
            >
              ...
              <MessageSquare className="absolute top-6 right-6 w-8 h-8 text-gray-200 group-hover:text-orange-500/20 transition-colors z-10" />
