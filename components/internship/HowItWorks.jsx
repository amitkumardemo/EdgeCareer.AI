        ...
        <div className="relative">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-8 lg:gap-4">
            {steps.map((step, i) => (
              ...
              >
                <div className="w-20 h-20 rounded-[2rem] bg-white border border-slate-200 flex items-center justify-center text-orange-400 mb-6 group-hover:bg-orange-500/10 group-hover:border-orange-500/40 group-hover:scale-110 group-hover:-translate-y-2 transition-all duration-300 shadow-md relative">
                  {step.icon}
                  <div className="absolute -top-2 -right-2 w-8 h-8 rounded-full bg-orange-500 text-white text-xs font-black flex items-center justify-center shadow-[0_4px_10px_rgba(249,115,22,0.4)]">
                    {i + 1}
                  </div>
                </div>
