        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {addons.map((addon, i) => (
            <motion.div
              ...
              className="p-6 rounded-3xl bg-white border border-slate-200 shadow-sm flex flex-col items-center text-center group cursor-default hover:border-blue-400 transition-all duration-300"
            >
              <div className="p-4 rounded-full bg-slate-50 mb-6 transition-colors">
                {addon.icon}
              </div>
              ...
              <div className="mt-auto pt-6 border-t border-slate-100 w-full flex items-center justify-between">
                ...
                <button className="p-2 rounded-full bg-slate-100 hover:bg-blue-600 hover:text-white transition-colors">
                  <Plus className="w-5 h-5 text-gray-900 hover:text-white" />
                </button>
              </div>
            </motion.div>
          ))}
