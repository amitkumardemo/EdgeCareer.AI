...
import { java, intern, overview, swag } from "./assets";
...
const Java = () => {
  ...
  return (
    <div className="et-root bg-white min-h-screen">
      ...
      {/* Hero Section */}
      <section className="relative pt-32 pb-24 overflow-hidden bg-gradient-to-br from-orange-50 via-white to-red-50">
        <div className="absolute top-0 right-0 w-[500px] h-[500px] bg-gradient-to-br from-orange-100/40 to-red-100/30 rounded-full blur-3xl -translate-y-1/2 translate-x-1/4 pointer-events-none" />
        <div className="absolute bottom-0 left-0 w-[400px] h-[400px] bg-gradient-to-tr from-amber-100/30 to-orange-100/20 rounded-full blur-3xl translate-y-1/2 -translate-x-1/4 pointer-events-none" />

        <div className="max-w-7xl mx-auto px-6 relative z-10">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <motion.div initial={{ opacity: 0, x: -40 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 0.7 }}>
              <div className="inline-flex items-center gap-2 bg-orange-600/10 border border-orange-200 text-orange-700 text-xs font-bold px-4 py-2 rounded-full mb-6 uppercase tracking-wider">
                <Star className="w-3.5 h-3.5" />
                Java Developer Internship
              </div>
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-black text-slate-900 leading-tight mb-6">
                Master <span className="bg-gradient-to-r from-orange-500 to-red-600 bg-clip-text text-transparent">Java</span> & Spring Boot for Real Projects
              </h1>
              <p className="text-lg text-slate-600 mb-6 leading-relaxed">
                Work on backend development using Java and Spring Boot frameworks. Gain hands-on experience with microservices, REST APIs, and real-world enterprise projects.
              </p>
              <div className="flex flex-wrap gap-3 mb-8">
                <span className="bg-white border border-slate-200 text-slate-700 text-sm font-medium px-3 py-1.5 rounded-lg shadow-sm">✔ Java & Spring Boot</span>
                <span className="bg-white border border-slate-200 text-slate-700 text-sm font-medium px-3 py-1.5 rounded-lg shadow-sm">✔ Microservices</span>
                <span className="bg-white border border-slate-200 text-slate-700 text-sm font-medium px-3 py-1.5 rounded-lg shadow-sm">✔ REST API Development</span>
              ...
              <div className="flex items-center gap-3 mb-8">
                <div className="flex -space-x-2">
                  {[1,2,3,4,5].map(i => (
                    <div key={i} className="w-8 h-8 rounded-full bg-gradient-to-br from-orange-400 to-red-500 border-2 border-white flex items-center justify-center text-white text-xs font-bold">{i}</div>
                  ))}
                </div>
            ...
            <motion.div initial={{ opacity: 0, x: 40 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 0.7, delay: 0.2 }}>
              <div className="bg-white rounded-3xl shadow-2xl shadow-indigo-100 border border-indigo-100 p-8">
                <div className="grid grid-cols-2 gap-4 mb-6">
                  {[
                    { value: "₹12 LPA", label: "Highest Package", color: "from-orange-500 to-red-600" },
                    { value: "95%", label: "Placement Readiness", color: "from-emerald-500 to-teal-600" },
                    { value: "15+", label: "Live Projects", color: "from-amber-500 to-orange-600" },
                ...
                <a href="https://payments.cashfree.com/forms?code=techiehelpinternship" target="_blank" rel="noopener noreferrer"
                  className="block w-full text-center bg-gradient-to-r from-orange-600 to-red-600 text-white font-bold py-3 rounded-xl hover:shadow-lg transition-all">
                  Enroll Now – ₹999/-
                </a>
      ...
      {/* Marquee */}
      <section className="bg-gradient-to-r from-orange-600 to-red-700 py-4 overflow-hidden">
          ...
          <AnimatedSection>
            <motion.div variants={fadeUp} className="text-center mb-14">
              <h2 className="text-3xl md:text-4xl font-black text-slate-900 mb-4">
                Why Choose <span className="bg-gradient-to-r from-orange-600 to-red-600 bg-clip-text text-transparent">TechieHelp</span>?
              </h2>
        ...
        <div className="max-w-7xl mx-auto px-6">
          <AnimatedSection>
            <motion.div variants={fadeUp} className="text-center mb-14">
              ...
              <p className="text-slate-500 text-lg">Flexible online & offline Java internship programs for students, freshers, and working professionals.</p>
            </motion.div>
            ...
            <p className="text-sm text-slate-500 text-center mb-4"><strong>Mode:</strong> Online &amp; Offline &nbsp;|&nbsp; <strong>Format:</strong> Live Sessions, Recordings, Doubt Solving, Hackathons &nbsp;|&nbsp; <strong>Tools:</strong> Java, Spring Boot, REST APIs, Microservices, and More</p>
        ...
        <div className="max-w-5xl mx-auto px-6">
          <AnimatedSection>
            <motion.div variants={fadeUp} className="text-center mb-12">
              <h2 className="text-3xl md:text-4xl font-black text-slate-900 mb-4">
                1-Month Java Developer Internship — <span className="text-indigo-600">₹999</span>
              </h2>
              ...
              <table className="w-full text-left">
                ...
                <tbody>
                  ...
                  <tr className="bg-white">
                    ...
                    <td className="px-6 py-4 font-semibold text-slate-800 text-sm align-top">Introduction to Java</td>
                    <td className="px-6 py-4 text-slate-600 text-sm">
                      <ul className="space-y-1">
                        <li className="flex items-start gap-2"><CheckCircle className="w-3.5 h-3.5 text-emerald-500 mt-0.5 flex-shrink-0" />Learn Java syntax and basics</li>
                        <li className="flex items-start gap-2"><CheckCircle className="w-3.5 h-3.5 text-emerald-500 mt-0.5 flex-shrink-0" />Write simple Java programs</li>
                        <li className="flex items-start gap-2"><CheckCircle className="w-3.5 h-3.5 text-emerald-500 mt-0.5 flex-shrink-0" />Setup development environment</li>
                      </ul>
                    </td>
                  </tr>
                  <tr className="bg-slate-50">
                    <td className="px-6 py-4 font-bold text-indigo-600 text-sm align-top">Week 2</td>
                    <td className="px-6 py-4 font-semibold text-slate-800 text-sm align-top">Spring Boot & REST APIs</td>
                    <td className="px-6 py-4 text-slate-600 text-sm">
                      <ul className="space-y-1">
                        <li className="flex items-start gap-2"><CheckCircle className="w-3.5 h-3.5 text-emerald-500 mt-0.5 flex-shrink-0" />Understand Spring Boot framework</li>
                        <li className="flex items-start gap-2"><CheckCircle className="w-3.5 h-3.5 text-emerald-500 mt-0.5 flex-shrink-0" />Build RESTful APIs</li>
                        <li className="flex items-start gap-2"><CheckCircle className="w-3.5 h-3.5 text-emerald-500 mt-0.5 flex-shrink-0" />Connect to databases</li>
                      </ul>
                    </td>
                  </tr>
                  <tr className="bg-white">
                    <td className="px-6 py-4 font-bold text-indigo-600 text-sm align-top">Week 3</td>
                    <td className="px-6 py-4 font-semibold text-slate-800 text-sm align-top">Microservices & Deployment</td>
                    <td className="px-6 py-4 text-slate-600 text-sm">
                      <ul className="space-y-1">
                        <li className="flex items-start gap-2"><CheckCircle className="w-3.5 h-3.5 text-emerald-500 mt-0.5 flex-shrink-0" />Build microservices</li>
                        <li className="flex items-start gap-2"><CheckCircle className="w-3.5 h-3.5 text-emerald-500 mt-0.5 flex-shrink-0" />Deploy Java applications on cloud</li>
                        <li className="flex items-start gap-2"><CheckCircle className="w-3.5 h-3.5 text-emerald-500 mt-0.5 flex-shrink-0" />API Gateway & Load Balancing</li>
                      </ul>
                    </td>
                  </tr>
                  <tr className="bg-slate-50">
                    ...
                    <td className="px-6 py-4 text-slate-600 text-sm">
                      <ul className="space-y-1">
                        <li className="flex items-start gap-2"><CheckCircle className="w-3.5 h-3.5 text-emerald-500 mt-0.5 flex-shrink-0" />Submit final Java project</li>
          ...
          <AnimatedSection>
            ...
            <div className="grid md:grid-cols-3 gap-8 items-start">
              <PriceCard title="1-Month Internship" price="₹999" originalPrice="₹2,000" badge="Beginner Friendly"
                features={[
                  "Java Developer Basics & Fundamentals", "Real-World Project Work", "Live Classes & AMAs with Mentors",
              ...
              <PriceCard title="2-Month Internship" price="₹1,499" originalPrice="₹3,000" badge="Best Value" recommended={true}
                features={[
                  "Everything in 1-Month Plan", "Advanced Java Developer Concepts", "Portfolio Review with Personalized Feedback",
      ...
      <section className="py-16 bg-gradient-to-r from-orange-600 to-red-700">
        <div className="max-w-4xl mx-auto px-6 text-center">
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}>
            <h2 className="text-3xl md:text-4xl font-black text-white mb-4">Ready to Start Your Java Developer Journey?</h2>
            <p className="text-orange-200 text-lg mb-8">Join 15,000+ students who transformed their careers with TechieHelp Institute of AI</p>
            <a href="https://payments.cashfree.com/forms?code=techiehelpinternship" target="_blank" rel="noopener noreferrer"
              className="inline-flex items-center gap-2 bg-white text-orange-700 font-black px-10 py-4 rounded-full hover:shadow-2xl hover:-translate-y-1 transition-all text-lg">
              Apply Now – Starting ₹999 <ArrowRight className="w-5 h-5" />
            </a>
            <p className="text-orange-200/70 text-sm mt-4">Limited seats available • No experience required</p>
          </motion.div>
        </div>
      </section>
