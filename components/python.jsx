...
const Python = () => {
  ...
  return (
    <div className="et-root bg-white min-h-screen text-slate-900">
      <style>
        {`
          @keyframes scroll {
      ...
      <section className="relative pt-32 pb-24 px-6 bg-gradient-to-br from-indigo-50 via-white to-purple-50 border-b border-indigo-100/30 text-slate-900 overflow-hidden">
        <div className="max-w-7xl mx-auto flex flex-col lg:flex-row items-center gap-8 w-full">
          {/* Left Content */}
          <div className="lg:w-1/2">
            <header>
              <div className="inline-flex items-center gap-1.5 bg-amber-100 text-amber-800 border border-amber-200 px-4 py-1.5 rounded-full text-xs font-bold mb-4 uppercase tracking-wide">
              ...
              <h1 className="text-3xl md:text-4xl font-bold mb-3 leading-snug max-w-4xl">
                <span className="text-indigo-600 font-bold">Python Developer</span> Internship & Training Program
              </h1>
              ...
              <div className="flex items-center gap-3 mb-4">
                <span className="text-xs text-slate-900">⭐ 4.6/5 Rated by 2,000+ Students | Trusted by Colleges & Recruiters</span>
              </div>

              {/* Inline CTA Buttons */}
              <div className="flex flex-col sm:flex-row gap-3">
                <a href="https://payments.cashfree.com/forms?code=techiehelpinternship" target="_blank" rel="noopener noreferrer">
                  <button className="bg-gradient-to-r from-indigo-600 to-purple-600 hover:from-indigo-700 hover:to-purple-700 text-white px-8 py-3 rounded-full font-bold text-sm transition-all duration-300 shadow-lg hover:shadow-xl hover:-translate-y-0.5">
                    Start Internship – ₹499/-
                  </button>
                </a>
                <button className="border-2 border-indigo-200 text-indigo-700 px-6 py-3 rounded-full font-bold text-sm transition-all duration-300 hover:bg-indigo-50 flex items-center gap-2">
  ...
  className="border-2 border-indigo-200 text-indigo-700 px-6 py-3 rounded-full font-bold text-sm transition-all duration-300 hover:bg-indigo-50 flex items-center gap-2"
>
  <Download className="w-4 h-4" />
  Download Internship Syllabus
</a>
              ...
              <p className="text-xs text-slate-600 mt-1">Limited seats • Certificate + Projects Included • Beginner Friendly</p>
            </header>
          </div>
          {/* Right Stats Card */}
          <div className="lg:w-1/2 max-w-lg">
            <div className="bg-white rounded-3xl shadow-2xl shadow-indigo-100 border border-indigo-100 p-8">
              ...
              <div className="grid grid-cols-2 gap-6 mb-8">
                <div className="bg-gradient-to-br from-blue-500 to-blue-700 text-white rounded-2xl p-6 text-center shadow-md">
                  <div className="text-3xl font-black text-white mb-2">10+</div>
                  <div className="text-sm text-white/90">Backend Systems</div>
                </div>
                <div className="bg-gradient-to-br from-emerald-500 to-green-700 text-white rounded-2xl p-6 text-center shadow-md">
                  <div className="text-3xl font-black text-white mb-2">REST</div>
                  <div className="text-sm text-white/90">API Architecture</div>
                </div>
                <div className="bg-gradient-to-br from-indigo-500 to-indigo-700 text-white rounded-2xl p-6 text-center shadow-md">
                  <div className="text-3xl font-black text-white mb-2">Django</div>
                  <div className="text-sm text-white/90">Web Frameworks</div>
                </div>
                <div className="bg-gradient-to-br from-amber-500 to-orange-600 text-white rounded-2xl p-6 text-center shadow-md">
                  <div className="text-3xl font-black text-white mb-2">95%</div>
                  <div className="text-sm text-white/90">Tech Placement</div>
                  <div className="text-3xl font-black text-white mb-2">15+</div>
                  <div className="text-sm text-white/90">Industry-Level Live Projects</div>
                </div>
                <div className="bg-gradient-to-br from-emerald-500 to-green-700 text-white rounded-2xl p-6 text-center shadow-md">
                  <div className="text-3xl font-black text-white mb-2">95%</div>
                  <div className="text-sm text-white/90">Students Improved Placement Readiness</div>
                </div>
                <div className="bg-gradient-to-br from-indigo-500 to-indigo-700 text-white rounded-2xl p-6 text-center shadow-md">
                  <div className="text-3xl font-black text-white mb-2">24/7</div>
                  <div className="text-sm text-white/90">Mentor & Career Support</div>
                </div>
                <div className="bg-gradient-to-br from-amber-500 to-orange-600 text-white rounded-2xl p-6 text-center shadow-md">
                  <div className="text-3xl font-black text-white mb-2">₹12 LPA</div>
                  <div className="text-sm text-white/90">Highest Reported Package</div>
                </div>
              </div>
              ...
              {/* CTA Button */}
              <a href="https://payments.cashfree.com/forms?code=techiehelpinternship" target="_blank" rel="noopener noreferrer" className="block">
                <button className="w-full py-3 px-6 bg-gradient-to-r from-indigo-600 to-purple-600 text-white font-bold rounded-xl hover:shadow-lg hover:shadow-indigo-200 transition-all block text-center">
                  Enroll Now – ₹499/-
                </button>
              </a>
      ...
      {/* Marquee Section */}
      <section className="w-full bg-gradient-to-r from-indigo-600 to-purple-700 py-4 overflow-hidden">
        <div className="animate-marquee flex items-center space-x-4 whitespace-nowrap">
          <span className="bg-white/15 backdrop-blur-sm border border-white/25 text-white rounded-full px-5 py-2 text-sm font-semibold whitespace-nowrap">Highest Package ₹12 LPA</span>
          <span className="bg-white/15 backdrop-blur-sm border border-white/25 text-white rounded-full px-5 py-2 text-sm font-semibold whitespace-nowrap">₹8 LPA</span>
          <span className="bg-white/15 backdrop-blur-sm border border-white/25 text-white rounded-full px-5 py-2 text-sm font-semibold whitespace-nowrap">₹6 LPA</span>
          <span className="bg-white/15 backdrop-blur-sm border border-white/25 text-white rounded-full px-5 py-2 text-sm font-semibold whitespace-nowrap">MSME Registered Training Partner</span>
          <span className="bg-white/15 backdrop-blur-sm border border-white/25 text-white rounded-full px-5 py-2 text-sm font-semibold whitespace-nowrap">National Internship Portal Certified</span>
          <span className="bg-white/15 backdrop-blur-sm border border-white/25 text-white rounded-full px-5 py-2 text-sm font-semibold whitespace-nowrap">ISO 9001:2015 Certified</span>
          <span className="bg-white/15 backdrop-blur-sm border border-white/25 text-white rounded-full px-5 py-2 text-sm font-semibold whitespace-nowrap">15,000+ Students Trained</span>
          <span className="bg-white/15 backdrop-blur-sm border border-white/25 text-white rounded-full px-5 py-2 text-sm font-semibold whitespace-nowrap">Industry Expert Trainers</span>
          <span className="bg-white/15 backdrop-blur-sm border border-white/25 text-white rounded-full px-5 py-2 text-sm font-semibold whitespace-nowrap">Live Project Based Training</span>
          <span className="bg-white/15 backdrop-blur-sm border border-white/25 text-white rounded-full px-5 py-2 text-sm font-semibold whitespace-nowrap">Career Support & Job Assistance</span>
          <span className="bg-white/15 backdrop-blur-sm border border-white/25 text-white rounded-full px-5 py-2 text-sm font-semibold whitespace-nowrap">Welcome Kit Provided</span>
          <span className="bg-white/15 backdrop-blur-sm border border-white/25 text-white rounded-full px-5 py-2 text-sm font-semibold whitespace-nowrap">4.6/5 Rating by 2,000+ Learners</span>
      ...
      <section className="bg-white py-20 px-6 md:px-12">
        <div className="max-w-7xl mx-auto text-center">
          <h2 className="text-3xl md:text-4xl font-black text-slate-900 mb-4">Why Choose TechieHelp Internship?</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            <div className="bg-white rounded-2xl shadow-sm border border-slate-100 p-6 flex items-start space-x-4 hover:shadow-lg hover:-translate-y-1 transition-all duration-300">
      ...
      <section className="bg-slate-50 py-20 px-6 md:px-12">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-black text-slate-900 mb-6"> Internship Overview</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-16">
            <div className="bg-white rounded-2xl shadow-sm border border-slate-100 p-8 hover:shadow-xl hover:-translate-y-1 transition-all duration-300 cursor-pointer group">
              <div className="text-center">
                <div className="bg-blue-100 rounded-2xl w-16 h-16 flex items-center justify-center mx-auto mb-4 group-hover:scale-110 transition-transform">
            ...
            <div className="bg-white rounded-2xl shadow-sm border border-slate-100 p-8 hover:shadow-xl hover:-translate-y-1 transition-all duration-300 cursor-pointer group">
              <div className="text-center">
                <div className="bg-green-100 rounded-2xl w-16 h-16 flex items-center justify-center mx-auto mb-4 group-hover:scale-110 transition-transform">
            ...
            <div className="bg-white rounded-2xl shadow-sm border border-slate-100 p-8 hover:shadow-xl hover:-translate-y-1 transition-all duration-300 cursor-pointer group">
              <div className="text-center">
                <div className="bg-purple-100 rounded-2xl w-16 h-16 flex items-center justify-center mx-auto mb-4 group-hover:scale-110 transition-transform">
            ...
            <div className="bg-white rounded-2xl shadow-sm border border-slate-100 p-8 hover:shadow-xl hover:-translate-y-1 transition-all duration-300 cursor-pointer group">
              <div className="text-center">
                <div className="bg-orange-100 rounded-2xl w-16 h-16 flex items-center justify-center mx-auto mb-4 group-hover:scale-110 transition-transform">
          ...
          <div className="mb-16">
            ...
            <div className="flex flex-wrap justify-center gap-4">
              <span className="bg-white border border-blue-200 text-blue-700 px-4 py-2 rounded-full text-sm font-semibold shadow-sm">Online Internship</span>
              <span className="bg-white border border-green-200 text-green-700 px-4 py-2 rounded-full text-sm font-semibold shadow-sm">Offline Classroom Training (Limited Seats)</span>
              <span className="bg-white border border-purple-200 text-purple-700 px-4 py-2 rounded-full text-sm font-semibold shadow-sm">Live Sessions</span>
              <span className="bg-white border border-orange-200 text-orange-700 px-4 py-2 rounded-full text-sm font-semibold shadow-sm">Recorded Videos</span>
              <span className="bg-white border border-red-200 text-red-700 px-4 py-2 rounded-full text-sm font-semibold shadow-sm">Doubt Solving Support</span>
              <span className="bg-white border border-indigo-200 text-indigo-700 px-4 py-2 rounded-full text-sm font-semibold shadow-sm">Hackathons & Assessments</span>
            </div>
          </div>
          ...
          <div className="bg-gradient-to-r from-indigo-600 to-purple-700 text-white py-14 px-8 rounded-3xl shadow-2xl shadow-indigo-200">
      ...
      <section className="bg-gradient-to-br from-blue-50 to-indigo-50 py-20 px-6 md:px-12">
        <div className="max-w-7xl mx-auto">
          {/* Section Header */}
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-black text-slate-900 mb-6">� What You Will Achieve</h2>
            <p className="text-xl text-gray-600 max-w-4xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
            <div className="bg-white rounded-2xl shadow-sm border border-slate-100 p-6 hover:shadow-xl hover:-translate-y-1 transition-all duration-300 group">
      ...
      <section className="bg-white py-20 px-6 md:px-12">
        <div className="max-w-7xl mx-auto">
          {/* Section Header */}
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-black text-slate-900 mb-6">Placement Support</h2>
            <p className="text-xl text-gray-600 max-w-4xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="bg-gradient-to-br from-gray-100 dark:from-slate-800 to-gray-200 dark:to-slate-900 rounded-xl shadow-lg p-8 text-slate-900 hover:shadow-xl transition-shadow duration-300 group">
              <div className="text-center">
                ...
                <p className="text-slate-600 text-sm leading-relaxed">Curated DSA sheets based on real hiring patterns of top companies.</p>
              </div>
            </div>
            ...
            <div className="bg-gradient-to-br from-gray-100 dark:from-slate-800 to-gray-200 dark:to-slate-900 rounded-xl shadow-lg p-8 text-slate-900 hover:shadow-xl transition-shadow duration-300 group">
              <div className="text-center">
                ...
                <p className="text-slate-600 text-sm leading-relaxed">One-to-one resume reviews to make your profile recruiter-ready.</p>
              </div>
            </div>
            ...
            <div className="bg-gradient-to-br from-gray-100 dark:from-slate-800 to-gray-200 dark:to-slate-900 rounded-xl shadow-lg p-8 text-slate-900 hover:shadow-xl transition-shadow duration-300 group">
              <div className="text-center">
                ...
                <p className="text-slate-600 text-sm leading-relaxed">Mock interviews, feedback sessions, and expert mentor support.</p>
              </div>
            </div>
            ...
            <div className="bg-gradient-to-br from-gray-100 dark:from-slate-800 to-gray-200 dark:to-slate-900 rounded-xl shadow-lg p-8 text-slate-900 hover:shadow-xl transition-shadow duration-300 group">
              <div className="text-center">
                ...
                <p className="text-slate-600 text-sm leading-relaxed">Access to job opportunities, referrals, and partner hiring drives.</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="bg-white py-20 px-6 md:px-12">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="text-center mb-12">
            <h2 className="text-4xl md:text-5xl font-black text-slate-900 mb-6">Mentor Guidance & Placement Support</h2>
            <p className="text-xl text-gray-600 max-w-4xl mx-auto">
    ...
    >
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="text-center">
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <button onClick={() => document.getElementById('student-reviews').scrollIntoView({ behavior: 'smooth' })} className="w-full py-3 px-6 bg-gradient-to-r from-indigo-600 to-purple-600 text-white font-bold rounded-xl hover:shadow-lg hover:shadow-indigo-200 transition-all block text-center">
      ...
      <section className="bg-white py-20 px-6 md:px-12">
        <div className="max-w-7xl mx-auto">
          {/* Section Header */}
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-black text-slate-900 mb-6">Technologies & Tools You Will Learn</h2>
            <p className="text-xl text-gray-600 max-w-4xl mx-auto">
      ...
      <section id="student-reviews" className="bg-slate-50 py-20 px-6 md:px-12">
        <div className="max-w-7xl mx-auto">
          {/* Section Header */}
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-black text-slate-900 mb-6"> Student Reviews & Success Stories</h2>
            <p className="text-xl text-gray-600 max-w-4xl mx-auto">
    ...
    <div className="aspect-[9/16]">
      ...
      <section className="bg-white py-20 px-6 md:px-12">
        <div className="max-w-7xl mx-auto">
          {/* Section Header */}
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-black text-slate-900 mb-6">Student Achievements & Certification Moments</h2>
            <p className="text-xl text-gray-600 max-w-4xl mx-auto">
            ...
            <div className="flex bg-gray-100 rounded-full p-1">
              <button
                ...
                className={`px-4 py-2 rounded-full font-semibold transition-colors ${
                  autoScroll ? 'bg-blue-600 text-slate-900' : 'text-blue-600'
                }`}
              >
                Auto Scroll
              </button>
      ...
      <section className="bg-slate-50 py-20 px-6 md:px-12">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12">
            <h2 className="text-4xl md:text-5xl font-black text-slate-900 mb-6">Program Timeline</h2>
            <p className="text-xl text-gray-600 max-w-4xl mx-auto">
