...
import { javascript, intern, overview, swag } from "./assets";
...
const JavaScript = () => {
  ...
  const curriculum = [
    { week: "Week 1", topic: "JavaScript Basics & Syntax", tasks: ["Learn JS fundamentals", "Understand variables, data types", "Write your first scripts"] },
    { week: "Week 2", topic: "ES6+ Features & DOM Manipulation", tasks: ["Master modern JavaScript", "Manipulate DOM elements", "Handle events"] },
    { week: "Week 3", topic: "Frameworks & Libraries", tasks: ["Work with popular JS frameworks", "Build interactive components", "Host projects online"] },
    { week: "Week 4", topic: "Final Project & Certification", tasks: ["Submit final JS project", "Personal review by mentors", "Receive certificate & badge"] },
  ];
  ...
  return (
    <div className="et-root bg-white min-h-screen">
      ...
      {/* Hero Section */}
      <section className="relative pt-32 pb-24 overflow-hidden bg-gradient-to-br from-indigo-50 via-white to-purple-50">
        {/* Decorative blobs */}
        <div className="absolute top-0 right-0 w-[500px] h-[500px] bg-gradient-to-br from-indigo-100/40 to-purple-100/30 rounded-full blur-3xl -translate-y-1/2 translate-x-1/4 pointer-events-none" />
        <div className="absolute bottom-0 left-0 w-[400px] h-[400px] bg-gradient-to-tr from-cyan-100/30 to-indigo-100/20 rounded-full blur-3xl translate-y-1/2 -translate-x-1/4 pointer-events-none" />
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <motion.div initial={{ opacity: 0, x: -40 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 0.7 }}>
              ...
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-black text-slate-900 leading-tight mb-6">
                Master <span className="bg-gradient-to-r from-indigo-600 to-purple-600 bg-clip-text text-transparent">JavaScript</span> & Build Real Projects
              </h1>
              ...
              <div className="flex flex-wrap gap-3 mb-8">
                {["✔ ES6+ & Modern JS", "✔ DOM Manipulation", "✔ Frameworks & Libraries", "✔ Certificate + Badge"].map(tag => (
                  <span key={tag} className="bg-white border border-slate-200 text-slate-700 text-sm font-medium px-3 py-1.5 rounded-lg shadow-sm">{tag}</span>
                ))}
              </div>
              <div className="flex items-center gap-3 mb-8">
                <div className="flex -space-x-2">
                  {[1,2,3,4,5].map(i => (
                    <div key={i} className="w-8 h-8 rounded-full bg-gradient-to-br from-indigo-400 to-purple-500 border-2 border-white flex items-center justify-center text-white text-xs font-bold">{i}</div>
                  ))}
                </div>
            ...
            <motion.div initial={{ opacity: 0, x: 40 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 0.7, delay: 0.2 }}>
              <div className="bg-white rounded-3xl shadow-2xl shadow-indigo-100 border border-indigo-100 p-8">
                <div className="grid grid-cols-2 gap-4 mb-6">
                  {[
                    { value: "₹12 LPA", label: "Highest Package", color: "from-indigo-500 to-indigo-700" },
                    { value: "95%", label: "Placement Readiness", color: "from-emerald-500 to-teal-600" },
                    { value: "15+", label: "Live Projects", color: "from-purple-500 to-violet-700" },
                ...
                <a
                  href="https://payments.cashfree.com/forms?code=techiehelpinternship"
                  target="_blank" rel="noopener noreferrer"
                  className="block w-full text-center bg-gradient-to-r from-indigo-600 to-purple-600 text-white font-bold py-3 rounded-xl hover:shadow-lg hover:shadow-indigo-200 transition-all"
                >
                  Enroll Now – ₹999/-
                </a>
      ...
      {/* Marquee */}
      <section className="bg-gradient-to-r from-indigo-600 to-purple-700 py-4 overflow-hidden">
          ...
          <AnimatedSection>
            <motion.div variants={fadeUp} className="text-center mb-14">
              <h2 className="text-3xl md:text-4xl font-black text-slate-900 mb-4">
                Why Choose <span className="bg-gradient-to-r from-indigo-600 to-purple-600 bg-clip-text text-transparent">TechieHelp</span>?
              </h2>
          ...
          <AnimatedSection>
            ...
            <div className="grid md:grid-cols-3 gap-6 mb-12">
              {[
                ...
                { icon: Trophy, title: "3 Months", desc: "Advanced Level", detail: "Full-stack JS mastery + career placement", color: "bg-purple-100 text-purple-600" },
              ].map(d => (
      ...
      {/* 1-Month Curriculum Table */}
      <section className="py-20 bg-slate-50">
        <div className="max-w-5xl mx-auto px-6">
          <AnimatedSection>
            <motion.div variants={fadeUp} className="text-center mb-12">
              <h2 className="text-3xl md:text-4xl font-black text-slate-900 mb-4">
                1-Month JavaScript Developer Internship — <span className="text-indigo-600">₹999</span>
              </h2>
              ...
              <table className="w-full text-left">
                ...
                <tbody>
                  {curriculum.map((row, i) => (
                    <tr key={row.week} className={i % 2 === 0 ? "bg-white" : "bg-slate-50"}>
                      ...
                      <td className="px-6 py-4 text-slate-600 text-sm">
                        <ul className="space-y-1">
                          {row.tasks.map(t => <li key={t} className="flex items-start gap-2"><CheckCircle className="w-3.5 h-3.5 text-emerald-500 mt-0.5 flex-shrink-0" />{t}</li>)}
                        </ul>
                      </td>
                    </tr>
                  ))}
            ...
            <div className="grid md:grid-cols-3 gap-8 items-start">
              ...
              <PriceCard
                ...
                features={[
                  ...
                  "Frameworks & Libraries Deep Dive",
                  "Portfolio Review with Personalized Feedback",
                  "Mini Hackathon + Mentor Recognition",
                  "Certificate of Excellence",
                  "Letter of Recommendation",
                  "Exclusive TechieHelp Merchandise",
                  "LinkedIn & YouTube Feature Opportunity",
                  "Featured Portfolio on Partner Networks",
                ]}
              />
              <PriceCard
                ...
                features={[
                  ...
                  "₹2,000 Cash Prize for Top Performers",
                  "Open Source Contribution Guidance",
                  "Certificate of Excellence",
                  "TechieHelp Internship T-Shirt",
                  "Final Jury Review by Industry Mentors",
      ...
      <section className="py-16 bg-gradient-to-r from-indigo-600 to-purple-700">
        <div className="max-w-4xl mx-auto px-6 text-center">
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}>
            <h2 className="text-3xl md:text-4xl font-black text-white mb-4">Ready to Start Your JavaScript Journey?</h2>
            <p className="text-indigo-200 text-lg mb-8">Join 15,000+ students who transformed their careers with TechieHelp Institute of AI</p>
            <a
              href="https://payments.cashfree.com/forms?code=techiehelpinternship"
              target="_blank" rel="noopener noreferrer"
              className="inline-flex items-center gap-2 bg-white text-indigo-700 font-black px-10 py-4 rounded-full hover:shadow-2xl hover:-translate-y-1 transition-all text-lg"
            >
              Apply Now – Starting ₹999 <ArrowRight className="w-5 h-5" />
            </a>
            <p className="text-indigo-200/70 text-sm mt-4">Limited seats available • No experience required</p>
          </motion.div>
        </div>
      </section>
