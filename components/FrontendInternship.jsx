          ...
          <div className="lg:w-1/2">
            <header>
              ...
              <h1 className="text-3xl md:text-4xl font-bold mb-3 leading-snug max-w-4xl">
                <span className="text-indigo-600 font-bold">Frontend Development</span> Internship & Training Program
              </h1>
          ...
          <div className="flex justify-end mb-8">
            <div className="flex bg-gray-100 rounded-full p-1">
              <button
                ...
                className={`px-4 py-2 rounded-full font-semibold transition-colors ${autoScroll ? 'bg-blue-600 text-slate-900' : 'text-blue-600'
                  }`}
              >
                Auto Scroll
              </button>
